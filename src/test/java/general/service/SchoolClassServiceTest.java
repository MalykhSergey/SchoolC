...
class SchoolClassServiceTest {
    ...
    void createSchoolClass() {
        ...
        Mockito.when(schoolClassRepository.findSchoolClassByNameAndClassNumberAndSchool(schoolClass.getName(), schoolClass.getClassNumber(), school)).thenReturn(schoolClass);
